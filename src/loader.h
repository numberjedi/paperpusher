...
/**
 * Open the file at `path` for reading, or create an empty file if it doesn't exist.
 * Returns a newly opened FILE* on success, or NULL on failure (errno set).
 */
FILE *open_file_read_or_create(const char *path);
